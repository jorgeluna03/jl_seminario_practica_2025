...
CREATE TABLE `turnero` (
  ...
  KEY `fk_turnero_cliente_idx` (`idCliente`),
  CONSTRAINT `fk_turnero_cliente` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2025-10-26 20:31:53
